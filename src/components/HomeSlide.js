            ...
            <div className="slide-wrapper flipImage transparent" id='1'>
                ...
                <div className="sliderTextContainer">
                    <div className="slide-inner-box">
                        ...
                        <h1>PEPPERONI</h1>
                        <h2>APIMENTADO</h2>
                        <Link to='/menu/pizza' onClick={()=>filterList('pizza')}><button className="order-now-btn" onClick={()=>filterList('sushi')}>Pedir Agora</button></Link>
                    </div>
                </div>
            ...
            <div className="slide-wrapper transparent" id='3'>
                ...
                <div className="sliderTextContainer">
                    <div className="slide-inner-box">
                        ...
                        <h1>CHÁ JAPONÊS</h1>
                        <Link to='/menu/sushi' onClick={()=>filterList('sushi')}><button className="order-now-btn" onClick={()=>filterList('sushi')}>Pedir Agora</button></Link>
                    </div>
                </div>
            ...
            <div className="slide-wrapper showSlide flipImage" id='2'>
                ...
                <div className="sliderTextContainer">
                    <div className="slide-inner-box">
                        ...
                        <h2>CHOCOLATE EM DOBRO</h2>
                        <Link to='/menu/desserts' onClick={()=>filterList('desserts')}><button className="order-now-btn" onClick={()=>filterList('sushi')}>Pedir Agora</button></Link>
                    </div>
                </div>
